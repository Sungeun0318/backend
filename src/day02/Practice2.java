...
당신의 키는 약 178cm 이군요. */
        ...
        System.out.println("당신의 키는 약 : " + (int) s1 + "cm 이군요");
...
평균 결과: 17.666666666666668 */
        System.out.print("정수 1 : "); int k1 = sc.nextInt();
        System.out.print("정수 2 : "); int k2 = sc.nextInt();
        System.out.print("정수 3 : "); int k3 = sc.nextInt();
        double 평균 = (k1 + k2 + k3) / 3.0 ; // int 평균 = (k1 +k2+k3)/3
