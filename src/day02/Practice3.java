...
//        int k = sc.nextInt();
//
//        System.out.println("총점 : " + (n+m+k));
//        System.out.println("평균 : " + (n+m+k)/3);
//
//
//
//
...
//        int d1 = sc.nextInt();
//        System.out.println(d1 % 2 == 0?  "false" : "true");
//
//
...
//        System.out.print("정수를 입력하세요 : ");
//        int d2 = sc.nextInt();
//        System.out.println(d2 * 7 == 0?  "false" : "true");
...
//        System.out.print("정수를 입력하세요 : ");
//        int k1 = sc.nextInt();
//        System.out.println(k1 % 7 ==0 && k1 % 2 !=0 ? "true" : "false");
...
//        double s1 = sc.nextDouble();
//        System.out.println((s1*9.0)/5.0 + 32);
...
//        int n5 = sc.nextInt();
//        System.out.println("2025년 기준 나이 : " + (2025 - n5)+"세");
...
//        System.out.println("BMI 지수 : " + s6/(s5*s5/10000));
...
//        System.out.printf(s1.equals("admin") && s2.equals("admin@test.com")? "관리자" : "일반 사용자");
...
//        int n = sc.nextInt();
//        System.out.println(n >= 90? "A" : (n >= 80? "B" : "C"));
...
//        int num = sc.nextInt();
//        System.out.println(num >= 20 && num <= 29? "이벤트 대상입니다" : "이벤트 대상이 아닙니다.");
