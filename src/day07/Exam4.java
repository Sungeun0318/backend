...
public class Exam4 {
    ...
    public static void main(String[] args) {
        ...
        // -> 프로그램내 공유 변수, 공유 메소드에 대해서 사용, 즉] 프로그램내 1개만 존재해야 하는 변수/메소드
...
//        멤버메소드(); //error // static 갖는 변수/메소드(main)는 우선할당 이므로 객체가 아닌 멤버메소드를 모른다.
        ...
        exam4.멤버메소드(); // ok
        정적메소드(); // ok // main메소드가 static갖고 정적메소드도 static 갖기 때문에 서로 알고 있는 상태<객체필요없음>
...
class D {
    ...
    // static 메소드 : 객체 유무 상관없이 호출 가능한 메소드
