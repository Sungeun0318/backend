...
public class Exam2 {
    public static void main(String[] args) {
        ...
        char str5 = '김';
        System.out.println("str5 = " + (int)str5); // str5 = 44608
        ...
        // 4. 주요 기능/메소드 : 문자열은 *불변*이다
            // 1) "문자열" .concat("새로운문자") : 문자열에 새로운문자열 연결하여 *(새로운)*반환 하는 함수
        ...
        // 8).replace(기존문자, 새로운문제) : 문자열내 기존문자가 존재하면 새로운문자로 치환하여 문자열반환
        ...
        // 10) .split("구분문자"), 구분문자 기분으로 잘라서 배열로 반환
        String[] str16 = "012345-1230123".split("-"); //str15 = 012345
