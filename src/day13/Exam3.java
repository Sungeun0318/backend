...
public class Exam3 {
    public static void main(String[] args) {
        ...
        int val1 = random.nextInt(); // INT 타입 허용 범위낸 난수 생성
        System.out.println("val1: " + val1); // val1: -1927430952
        int val2 = random.nextInt(10); // val2: 6
        ...
        System.out.println("val4: " + val4); // val4: 0.9106466367236447
        // 4)
        boolean val5 = random.nextBoolean();
        System.out.println("val5: " + val5); // val5: true
        ...
        System.out.println("uuid = " + uuid); // uuid = e1b2e0c8-71dd-4245-ae1d-3612e7b8e61f
        ...
        /*
            UUID 장점
                ...
                - 데이터베이스 PK, 파일명, 로그인세션(Token) 등등
                    - (mysql) auto_increment : 1 2 3 4 5 순으로 증가하면 편하고 노출이 쉽다.
                    - UUID : 난수이므로 무섭고 노출이 어렵다.
