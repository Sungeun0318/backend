...
public class Practice8 {
    public static void main(String[] args) {
        ...
        Lamp lamp = new Lamp();
        lamp.turnOn();
        System.out.println("램프 상태: " + lamp.isOn);
        lamp.turnOff();
        System.out.println("램프 상태: " + lamp.isOn);
        ...
        product.name = "노트북";
        product.stock = 10;
        System.out.println("구매 성공 여부: " + product.sell(10));
        ...
        System.out.println("주차 요금(65분): " + parkingLot.calculateFee(65));
        System.out.println("주차 요금(140분): " + parkingLot.calculateFee(140));
    }
