...
public class exam1 {
    public static void main(String[] args) {
        ...
        try {
            ...
            int int2 = Integer.parseInt(str2); // "100" -> 100 [ok], "1abc" -> [no], NumberFormatException
        ...
        try {
            ...
            System.out.println(ary[3]); // 3번 인덱스 값은 없다. ** 예외 발생
        ...
        try {
            ...
            System.out.println("예외발생 : 입력할 수 없는 정보 또는 잘못된 형식입니다.");
        }

        // 7) 예외는 다양한 이율 발생한다. 예외 중에 상위(부모)클래스가 존재한다. Exception 클래스
        try{
